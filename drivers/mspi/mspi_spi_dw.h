...
struct mspi_spi_dw_data {
	uint32_t max_freq;
	struct mspi_spi_dw_dev_config slv_cfg[CONFIG_MSPI_SPI_DW_SLAVE_COUNT];
	struct k_sem lock;
...
#define DW_SPI_REG_TXD_DRIVE_EDGE	(0xf8)
...
#define DW_SPI_CTRLR0_SPI_RXDS_EN       BIT(18)
#define DW_SPI_CTRLR0_INST_DDR_EN	BIT(17)
#define DW_SPI_CTRLR0_SPI_DDR_EN	BIT(16)
...
DEFINE_MM_REG_WRITE(txd_drive_edge, DW_SPI_REG_TXD_DRIVE_EDGE, 32)
